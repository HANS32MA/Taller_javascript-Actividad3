...
function consulta_individual(id) {
  ...
  const visualizar = (data) => {
      ...
      document.getElementById("email").value = data.baul.email;
  };
}
...
async function register() {
  ...
  try {
      ...
      if (data.mensaje === "Registro agregado") {
          alert(data.mensaje);
          cerrarModal();
      } else {
          alert(data.mensaje);
...
function recuperarCuenta() {
    ...
    // Aquí iría tu lógica para enviar la solicitud de recuperación
    // Puedes usar fetch para enviar los datos al servidor

    console.log("Usuario:", username);
    console.log("Correo:", email);
    alert("Solicitud Enviada"); // Reemplazar con tu lógica
}